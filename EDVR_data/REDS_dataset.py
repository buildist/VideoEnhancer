    ...
    def __getitem__(self, index):
        ...
        for v in neighbor_list:
            ...
            if self.data_type == 'mc':
                ...
                img_LQ = util.read_img(self.LQ_env, '{}_{:08d}'.format(name_a, v+1), LQ_size_tuple)
            else:
                img_LQ = util.read_img(None, 'D:/Datasets/REDS/train_LR_cinepak_vdub/{:s}/{:08d}.png'.format(name_a, v+1))
            img_LQ_l.append(img_LQ)
            torchvision.utils.save_image(img_GT, 'GT.png')
            torchvision.utils.save_image(img_LQ_l, 'LQ.png')
